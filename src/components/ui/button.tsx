  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-background hover:bg-secondary-hover hover:text-secondary-foreground shadow-custom-sm",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-hover shadow-custom-sm",
        ghost: "hover:bg-secondary hover:text-secondary-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        success: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-custom-sm hover:shadow-custom-md",
        gradient: "bg-gradient-primary text-white hover:scale-105 transition-bounce shadow-glow",
      },
      size: {
